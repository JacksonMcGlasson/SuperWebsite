<?php
//redirects users to a random page in thge array
$urls = array('http://localhost/Super-Website/gallery.php', "http://localhost/Super-Website/article1.php",
    "http://localhost/Super-Website/article2.php", "http://localhost/Super-Website/article3.php", 
    "http://localhost/Super-Website/article4.php"); //specify array of possible URLs
